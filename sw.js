const CACHE='mehirli-v112';
const ASSETS=['./','./index.html','./landing.css?v=74','./mechirli-hero-profit-v68.webp','./mehirli-hero-v43.jpg','./mehirli-explainer-poster-v62.jpg','./app.html','./reset-password.html','./style.css?v=112','./app.js?v=112','./sample-quote.html','./quote.html','./quote-preview-v61.jpg','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-maskable-192.png','./share-preview-v20.jpg','./share.html'];
