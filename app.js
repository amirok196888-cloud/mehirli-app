...
$$('#proJobForm .trade-choice').forEach(button=>button.onclick=()=>{if($('#proJobTrade').value===button.dataset.trade)return;setTrade(button.dataset.trade);$('#proJobType').value='';saveProJobDraft()});
...
$$('#proJobForm [data-next-step]').forEach(button=>button.onclick=()=>setJobStep(Number(button.dataset.nextStep)));
