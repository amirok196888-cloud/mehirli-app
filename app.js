...
async function openNewProJob(){
  ...
  const s=await loadProSettings();await Promise.all([loadProCustomers(),loadProServices()]);$('#proJobForm').reset();state.quoteItems=[];renderQuoteItemsEditor();renderCustomerOptions();setTrade('general');
